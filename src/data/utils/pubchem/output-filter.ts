export type TPubchemOperationType =
  "MolecularFormula" |
  "MolecularWeight" |
  "CanonicalSMILES" |
  "IsomericSMILES" |
...
export const pubchemOperationChoices: { text: string; val: TPubchemOperationType }[] = [
...
export type TPubchemOutputFilterChoice = "all"|"property"|"description"|"synonyms"

type TPubchemOutputFilterChoices = { val: TPubchemOutputFilterChoice, text: string }[]
export const pubchemOutputFilterChoices:TPubchemOutputFilterChoices = [
  {val: "all", text:"All Records"},
  {val: "property", text:"Property"},
  {val: "description", text:"Description"},
  {val: "synonyms", text:"Synonyms"},
]

// export type TPubchemOutputFilter<T extends TPubchemOutputFilterChoice> =
//   T extends "all" ? "" :
//   T extends "property" ? TPubchemOperationType:
//   T extends "description"|"synonyms" ? T : never

export type TPubchemOutputFormat = "json"|"png"